...
function downloadSVG() {
  ...
  // The ui.js renderDownloadSVG function ALREADY performs the 10x scale 
  // (converting internal mm to the user's expected cm).
  // We just need to get that string and download it.
